...
export const TopicInput: React.FC<TopicInputProps> = ({ topic, setTopic, onStart, isLoading, previousTopics }) => {
  const isDuplicate = previousTopics.includes(topic.trim()) && topic.trim() !== '';

  return (
    <div className="p-6 bg-slate-800/50 rounded-lg border border-slate-700">
      <h2 className="text-xl font-bold text-white mb-4">1. Enter Your Topic</h2>
