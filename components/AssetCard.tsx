...
export const AssetCard: React.FC<AssetCardProps> = ({ asset }) => {
  ...
  return (
    <div className="bg-slate-800 rounded-lg p-3 flex items-center gap-4 transition-transform transform hover:scale-105 hover:bg-slate-700/50">
      <div className={color}>
        {icon}
      </div>
      ...
      <button
        ...
        className="flex-shrink-0 bg-indigo-600 hover:bg-indigo-500 text-white rounded-full p-2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-indigo-500"
